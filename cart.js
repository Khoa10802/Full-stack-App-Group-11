...
function load_itm_list() {
    ...
    for (let i = 0; i < len; i++) {
        ...
        items[i].innerHTML += "<div class=\"item-description\">" + cart_items[i]['description'];
        items[i].innerHTML += "<div class=\"item-price\">" + cart_items[i]['price'];
        items[i].innerHTML += "<div class=\"remove_btn\">" + 
